...
Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Alex Under, Fullname (1)'), 'Bagus S', 
    0)

Mobile.tap(findTestObject('Object Repository/Register/android.widget.EditText - alexemail.com, Email'), 0)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - alexemail.com, Email (1)'), 'bagus@gmail.com', 
    0)

Mobile.tap(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password'), 0)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password (1)'), 'bagus123', 
    0)
