...
class register {
	...
	def UserInputValidFullname(String fullname) {
		...
		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Alex Under, Fullname (1)'), 'Bagus Cipta', 0)
	}
	...
	def UserInputValidEmail(String email) {
		...
		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - alexemail.com, Email (1)'), 'bagus13@gmail.com', 0)
	}
	...
	def UserInputValidPassword(String password) {
		...
		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password (1)'), 'bagus124', 0)
	}
	...
	def UserEnterValidFullname(String fullname) {
		...
		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Alex Under, Fullname (1)'), 'Bagus M', 0)
	}
	...
	def UserInputPassword(String password) {
		...
		Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - 123123123, Password (1)'), 'bagus17', 0)
	}
