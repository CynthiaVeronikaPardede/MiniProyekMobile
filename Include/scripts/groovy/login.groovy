...
class login {
	...
	def UserEnterEmail(String email) {
		...
		Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - Email (1)'), 'frizzi12@gmail.com', 0)
	}
	...
	def UserEnterPassword(String password) {
		...
		Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - Password (1)'), 'testing123', 0)
	}
	...
	def UserInputWithInvalid(String email) {
		Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText - Email'), 0)

		Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText - Email (1)'), 'frizzi12@gmail', 0)
	}

	@And("User input with invalid (.*) password")
	def UserInputWithInvalidPassword(String password) {
		Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText - Password'), 0)
